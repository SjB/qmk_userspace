...
#define SB_BHRL  BHRL(KC_ENT)
#define SB_MOUSE MOUSE(KC_ESC)
...
#define RIGHT_HOME_ROW KC_TAB , OSM_CTL, OSM_SFT, OSM_GUI, OSM_ALT
...
#define RIGHT_MOUSE_ROW_2 KC_TAB , KC_MS_L, KC_MS_D, KC_MS_R, KC_ACL1
...
#define LEFT_MOUSE_ROW_3 KC_DEL  , SB_CWTG, KC_HOME, C(KC_V), SB_EXTRA
...
#define LEFT_PRIMARY_THUMB_CLUSTER  OSM_SFT, SB_NAV, SB_MOUSE
#define RIGHT_PRIMARY_THUMB_CLUSTER SB_BHRL , SB_RSE, OSM_GUI
