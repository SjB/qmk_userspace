...
SJB_DEFINE_KEY(CK_LESC,   HRM_COL4(LEFT_QW_ROW_2),  HRM_COL5(LEFT_QW_ROW_2));
SJB_DEFINE_KEY(CK_RESC,   HRM_COL1(RIGHT_QW_ROW_2), HRM_COL2(RIGHT_QW_ROW_2));
...
SJB_DEFINE_KEY(CK_KEY_LREP, HRM_COL4(LEFT_QW_ROW_3), HRM_COL3(LEFT_QW_ROW_3));
SJB_DEFINE_KEY(CK_KEY_RREP, HRM_COL2(RIGHT_QW_ROW_3), HRM_COL3(RIGHT_QW_ROW_3));
#endif

#if !(defined(ACHORDION_ENABLE) || defined(CHORDAL_HOLD))
...
SJB_DEFINE_KEY(CK_LLLCK, SB_BSPC, SB_ESC);
SJB_DEFINE_KEY(CK_RLLCK, SB_SPC, SB_ENT);
#endif
...
combo_t key_combos[] = {
    ...
    SJB_COMBO(CK_RSTL, SB_RSTL),
    SJB_COMBO(CK_LESC, KC_ESC),
    SJB_COMBO(CK_RESC, KC_ESC),
...
#if defined(LAYER_LOCK_ENABLE)
    SJB_COMBO(CK_LLLCK, SB_EXTRA),
    SJB_COMBO(CK_RLLCK, SB_EXTRA),
#endif
