...
SJB_DEFINE_KEY(CK_LAYER_LOCK, HRM_COL2(RIGHT_QW_ROW_3), HRM_COL3(RIGHT_QW_ROW_3));
#endif

#ifdef KEY_LOCK_ENABLE
SJB_DEFINE_KEY(CK_KEY_LOCK, HRM_COL4(LEFT_QW_ROW_3), HRM_COL3(LEFT_QW_ROW_3));
#endif

#ifdef CAPS_WORD_ENABLE
SJB_DEFINE_KEY(CK_CWTOGG,   HRM_COL2(LEFT_QW_ROW_2), HRM_COL3(LEFT_QW_ROW_2));
#endif
